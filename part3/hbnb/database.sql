...
CREATE TABLE IF NOT EXISTS `places` (
    ...
    _longitude FLOAT,
    _owner_id CHAR(36),
    FOREIGN KEY (_owner_id) REFERENCES `users` (id)
);
...
VALUES (
        ...
        'Admin',
        'HBnB',
        '$2b$12$HRaI5zBYJBdazSF8lNFRdecX.lDUmZ0wFSyIF/jMTq.uKHoo27xEq',
        TRUE
    );

INSERT INTO
    `amenities` (id, _name, _description)
VALUES (
    ...
    (
        lower(hex(randomblob (16))),
        'Swimming Pool',
        'Swimming is good, drowning is blblbllbl'
    ),
    (
        lower(hex(randomblob (16))),
        'Air Conditioning',
